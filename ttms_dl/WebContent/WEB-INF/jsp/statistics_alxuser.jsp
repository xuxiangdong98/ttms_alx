	...
	<div class="container-fluid">
		<article>
			...
			<span id="alxUser_count"></span>
				<div id="chartmain" style="margin: 0px auto; width: 80%;height:570px; background-color: #F0F8FF;">
...
<script type="text/javascript">
    ...
    function fuzhi(myChart){
        $.ajax({
            ...
            type : "GET",
            url : "<%=basePath%>ttms/statistics_AlxUser.action",
            dataType : "json",
